package com.exoapps.pickuplines.flirtymessages.utilities
...
import com.exoapps.pickuplines.flirtymessages.ads_manager.NativeAds.isDebug
import com.exoapps.pickuplines.flirtymessages.model.LanguageModel
...
var id_inter_main_medium =
    if (isDebug()) "ca-app-pub-3940256099942544/1033173712" else "ca-app-pub-4104396910571415/1965166202"
var id_native_screen = ""
var id_app_open_screen = "ca-app-pub-4104396910571415/9296861316"
var id_banner_screen = "ca-app-pub-4104396910571415/5904411212"
    ...
    try {
        startActivity(
            Intent(
                ...
                Uri.parse("https://play.google.com/store/apps/developer?id=Exogames ")
            )
        )
    } catch (e: Exception) {
        e.printStackTrace()
...
fun Context.privacyPolicy() {
    try {
        startActivity(
            Intent(
                "android.intent.action.VIEW",
                Uri.parse("https://exogamesnew1437.blogspot.com/2024/02/flirt-messages-pickup-lines.html")
            )
        )
    } catch (e: Exception) {
        e.printStackTrace()
